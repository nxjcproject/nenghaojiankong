<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="template1.aspx.cs" Inherits="Monitor.Web.UI_Monitor.ProcessEnergyMonitor.zc_nxjc_qtx_efc_clinker02.view.template1" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        var pageData = {
            tabIndex: 1,
            organizationId: "zc_nxjc_qtx_efc_clinker02",
            viewName: "2#石灰石破碎",
            tableDataView: "RawBatch_ClinkerProductionLine"
        };
    </script>
