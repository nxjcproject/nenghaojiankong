...
function LoadEnergyAlarmNodesData(myNodeId) {
    $.ajax({
        type: "POST",
        url: "MachineHaltAlarmMonitor.aspx/GetAlarmNodes",
...
function LoadSubEnergyAlarmNodesData(myParentLevelCode) {
    $.ajax({
        type: "POST",
        url: "MachineHaltAlarmMonitor.aspx/GetAlarmNodesByParentLevelCode",
...
function BackToUpFun() {
    if (AlarmGroup[0].LevelCode != "") {
        $.ajax({
            type: "POST",
            url: "MachineHaltAlarmMonitor.aspx/GetAlarmParentNodesByLevelCode",
...
function GetAlarmValues() {
    ...
    $.ajax({
        type: "POST",
        url: "MachineHaltAlarmMonitor.aspx/GetAlarmValueByLevelCode",
