...
function LoadEnergyAlarmNodesData(myNodeId) {
    $.ajax({
        type: "POST",
        url: "SlaverHaltDelayAlarmMonitor.aspx/GetAlarmNodes",
...
function LoadSubEnergyAlarmNodesData(myParentLevelCode) {
    $.ajax({
        type: "POST",
        url: "SlaverHaltDelayAlarmMonitor.aspx/GetAlarmNodesByParentLevelCode",
...
function BackToUpFun() {
    if (AlarmGroup[0].LevelCode != "") {
        $.ajax({
            type: "POST",
            url: "SlaverHaltDelayAlarmMonitor.aspx/GetAlarmParentNodesByLevelCode",
...
function GetAlarmValues() {
    ...
    $.ajax({
        type: "POST",
        url: "SlaverHaltDelayAlarmMonitor.aspx/GetAlarmValueByLevelCode",
